...
public class Carro {
    ...
    static String marca;
    static int ano;
    static boolean ehFlex;

    static int qtPortas;

    double combustivelAtual;

    static double consumo; // qts kms por litro
    ...
    Carro(String modelo, String marca, int ano, boolean ehFlex, int qtPortas, double consumo) {
        ...
        this.combustivelAtual = 30.0; // todos os carro começa, com 30L
    ...
    //Abastecer
    void abastecer(double total) { //parâmetros
    ...
    boolean viajar(String local, double distancia) { //tentar viajar se conseguir true, senão false
        ...
        //Calcula quantos litros necessários para a viagem
